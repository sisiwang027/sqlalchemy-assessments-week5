...
class Model(db.Model):
    ...
    model_id = db.Column(db.String(5), autoincrement=True, primary_key=True)
    ...
    def __repr__(self):
        return "<Model model_id={} brand_id={}>".format(self.model_id, self.brand_id)
...
class Award(db.Model):
    ...
    model = db.relationship('Model', backref=db.backref('award'))

    def __repr__(self):
        return "<Awards award_id={} winner_id={}>".format(self.award_id, self.winner_id)
